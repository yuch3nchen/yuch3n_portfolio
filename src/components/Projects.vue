  ...
  <div class="container mx-auto md:px-16 px-4 xl:px-48 mt-20">
    ...
    <div class="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-3 mb-12">
      ...
      >
        ...
        />
        <div
          class="absolute inset-0 m-2 bg-white/70 backdrop-blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center rounded gap-3"
        >
          <h3
